...
<body>
        ...
        <div class="container ">
            <div class="row justify-content-between">
                <div class="col-md-7 text-between">
                    <h1 class="display-4">Booking Kost, Hanya di Mamikost</h1>
                ...
                <div class="col">
                    <div class="container text-end">
                        <img class="img" src="images/section1.png" alt="MAMIKOST" width="400" >
                    </div>
                </div>
                <hr class="my-4">
    ...
    <div class="container">
        ...
        <div class="row shadow text-between">
            <?php
            foreach ($kosts as $kost) {
                echo "<div class='col-md-4 mb-3' data-aos='zoom-in-up' data-aos-duration='1000'>";
                echo "<div class='card' style='width: 26rem;'>";
                echo "<img src='images/" . $kost["image"] . "' class='card-img-fluid' alt='" . $kost["id"] . "'>";
    ...
    <script>
        ...
        gsap.from('.img', {duration: 1.5, y:'-100%', opacity: 0, ease: 'elastic'})
        gsap.from('.container', {duration: 1.5, opacity: 0, ease: 'power3'})
    </script>
</body>
</html>